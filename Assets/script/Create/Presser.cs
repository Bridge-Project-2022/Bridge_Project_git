...
public class Presser : MonoBehaviour
{
    ...
    public void PresserStart()//압착 과정 시작
    {
        ...
        else if (ClickedItem.name.Equals("우정"))
        {
            if (PressCount == 2)
                PressItem.tag = "good";
        ...
        else if (ClickedItem.name.Equals("즐거움"))
        {
            if (PressCount == 1)
                PressItem.tag = "good";
            else if (PressCount == 4)
        ...
        else if (ClickedItem.name.Equals("분노"))
        {
            if (PressCount == 2)
                PressItem.tag = "good";
            else if (PressCount == 3)
        ...
        else if (ClickedItem.name.Equals("후화"))
        {
            if (PressCount == 5)
                PressItem.tag = "good";
            else if (PressCount == 8)
        ...
        else if (ClickedItem.name.Equals("공포"))
        {
            if (PressCount == 4)
                PressItem.tag = "good";
            else if (PressCount == 7)
