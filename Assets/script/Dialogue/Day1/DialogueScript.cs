...
public class DialogueScript : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        {
            Customer_ID[i] = Random.Range(0,9);
            for (int j = 0; j < i; j++)
            {
    ...
    public void Update()
    {
        ...
        Customer A = CustomerManager.Instance.days.day[0].customer[3];
        Customer E = CustomerManager.Instance.days.day[0].customer[4];
        Customer I = CustomerManager.Instance.days.day[0].customer[5];
        Customer C = CustomerManager.Instance.days.day[0].customer[6];
        Customer D = CustomerManager.Instance.days.day[0].customer[7];
