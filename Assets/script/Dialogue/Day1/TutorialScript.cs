...
public class TutorialScript : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        tutCreate[0] = "그렇다면 이 또한 설명해주도록 하지."; tutCreate[1] = "여기, 이 상자는 자네가 구매한 향료를 보관한 곳이라네."; tutCreate[2] = "이곳에서 손님의 주문에 맞는 향료를 선택한 후, 노트에 맞게끔 총 3개의 제조 과정을 거치면 되지."; tutCreate[3] = "혹시라도 주문이 기억나지 않더라도 안심하게나, 이곳에서 다시 볼 수 있으니."; tutCreate[4] = "그럼 베이스 노트부터 골라볼까.";
        ...
        tutCreate[26] = "키보드의 좌우 방향키(←→) 중 하나를 누르거나 양쪽을 다 눌러서 압착을 하게나"; tutCreate[27] = "제대로 빻지 않으면 향이 지나치게 약하게 우러나올테니 주의하게나."; tutCreate[28] = "그럼, 한번 해보겠는가?"; tutCreate[29] = ""; tutCreate[30] = "오호, 솜씨가 상당한데? 완성될 향이 기대되는군."; tutCreate[31] = "마지막은 탑 노트라네. 다시 이리로 와보게나."; 
