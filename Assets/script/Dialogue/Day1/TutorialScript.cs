...
public class TutorialScript : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        tutCreate[5] = "베이스 노트의 향료는 끓이는 과정을 거쳐 향을 추출할 수 있다네."; tutCreate[6] = "때문에 '증류기'를 사용해야만 해."; tutCreate[7] = "또 내 주문과 같은 경우에는 설산을 추억하는 것이었으므로 '장소'에 해당하는 향료를 써야겠지."; tutCreate[8] = "자아, '장소'에 해당하는 향료를 선택해보게.";tutCreate[9] = "옳지. 혹시라도 향료를 다른 것으로 바꾸고 싶다면 여길 눌러 초기화하면 된다네."; 
        ...
        tutCreate[21] = "그러므로 '압착기'를 거쳐야 한다네. ...우선 향료를 골라보지."; tutCreate[22] = "내가 설산을 여행을 겸하여 갔다고 말한 것을 기억하는가? 그래, 그에 맞는 향료를 골라주게나."; tutCreate[23] = "잘했네, 이제 압착기 쪽으로 오도록 하게."; tutCreate[24] = "압착 과정은 이 아이가 도와줄걸세."; tutCreate[25] = "자네가 여기, 리듬에 맞추어 오른쪽, 또는 왼쪽을 알맞게 지시하면 그대로 이행하는 것이지."; 
        ...
        tutCreate[32] = "탑 노트의 향료는 주로 향유를 만드는 냉침 과정을 거친다네. 말에서도 알 수 있듯 '냉침기'를 사용하지."; tutCreate[33] = "이 노트의 향료들은 손님의 감정을 드러낸다는 것을 기억하는가?"; tutCreate[34] = "나는 설산에 올라가서 기쁨을 느꼈다는걸 기억해보며, 어디 향료를 골라보게나."; tutCreate[35] = "잘했네. 이제 마지막 과정만 남았으니 힘내도록 하게."; tutCreate[36] = "냉침기를 통해 향을 추출하는 법은 간단하네."; 
        ...
        tutCreate[43] = "자아, 세 과정을 거쳤으니 이제 향수는 완성이 되었다네."; tutCreate[44] = "정말이지 그 설산의 기억이 또렷이 떠오르는, 아주 훌륭한 향수군."; tutCreate[45] = "완성한 향수를 손님에게 전달하려면 여기, 향수병을 클릭하게나."; tutCreate[46] = "아, 마지막으로 하나 더. 완성 이전에 향수를 클릭한다면 그 때에도 곧바로 손님에게 전달될테니 조심하게.";
