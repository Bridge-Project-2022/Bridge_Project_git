...
public class TutorialScript : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        tutCreate[5] = "베이스 노트의 향료는 끓이는 과정을 거쳐 향을 추출할 수 있다네."; tutCreate[6] = "때문에 '증류기'를 사용해야만 해."; tutCreate[7] = "또 내 주문과 같은 경우에는 어느 한 '동물'을 추억하는 것이었으므로 그에 해당하는 향료를 써야겠지."; tutCreate[8] = "자아, '동물'에 해당하는 향료를 선택해보게."; tutCreate[9] = "옳지. 혹시라도 향료를 다른 것으로 바꾸고 싶다면 여길 눌러 초기화하면 된다네."; 
